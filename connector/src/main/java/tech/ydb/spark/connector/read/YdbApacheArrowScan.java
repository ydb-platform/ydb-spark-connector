 ...
 * @author zinal
 */
public class YdbApacheArrowScan implements Batch, Scan, ScanBuilder, SupportsReportPartitioning, PartitionReaderFactory,
        SupportsPushDownV2Filters, SupportsPushDownRequiredColumns, SupportsPushDownLimit, SupportsPushDownAggregates  {
    private static final long serialVersionUID = -7798203774297109000L;
    private static final Logger logger = LoggerFactory.getLogger(YdbApacheArrowScan.class);
    ...
    public YdbApacheArrowScan(YdbTable table, CaseInsensitiveStringMap options) {
        this.table = table;
