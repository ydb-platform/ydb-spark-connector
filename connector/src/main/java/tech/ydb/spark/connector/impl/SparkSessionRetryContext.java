...
public class SparkSessionRetryContext {
    ...
    private SparkSessionRetryContext(Builder b) {
    ...
    public static final class Builder {
        ...
        public SparkSessionRetryContext build() {
            return new SparkSessionRetryContext(this);
        }
    }
}
